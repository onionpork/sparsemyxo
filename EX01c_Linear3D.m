...
[x1_val, x1_idx] = datasample(x(:,1), floor(length(x(:,1))/20));
[x2_val, x2_idx] = datasample(x(:,2), floor(length(x(:,1))/20));
[x3_val, x3_idx] = datasample(x(:,3), floor(length(x(:,1))/20));


t_species_matrix = nan(length(t), 3);
